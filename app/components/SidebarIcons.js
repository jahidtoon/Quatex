...
export const menuIcons = {
  ...
  support: { icon: 'fa-question-circle', color: 'text-yellow-400', label: 'Support' },
  ...
  withdrawal: { icon: 'fa-arrow-up', color: 'text-red-400', label: 'Withdrawal' },
  transactions: { icon: 'fa-receipt', color: 'text-orange-400', label: 'Transactions' },
};
